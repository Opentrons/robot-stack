...
# release
# https://builds.opentrons.com/app/releases.json - app - edge routes latest*; yml are authoritative for updater.
...
# Internal
# https://ot3-development.builds.opentrons.com/app/releases.json - app - edge routes latest*; yml are authoritative for updater.
